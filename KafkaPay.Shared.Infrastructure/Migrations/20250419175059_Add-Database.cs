    ...
    public partial class AddDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TnxTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TnxTransactions_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TnxTransactions_Accounts_FromAccountId",
                        column: x => x.FromAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TnxTransactions_Accounts_ToAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TnxTransactions_AccountId",
                table: "TnxTransactions",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_TnxTransactions_FromAccountId",
                table: "TnxTransactions",
                column: "FromAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_TnxTransactions_StatusId",
                table: "TnxTransactions",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_TnxTransactions_ToAccountId",
                table: "TnxTransactions",
                column: "ToAccountId");
        }
